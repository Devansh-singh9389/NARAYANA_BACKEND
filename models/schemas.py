...
class SceneExtraction(BaseModel):
    ...
    # --- THE FIX: Use a list of models instead of a dict! ---
    ...
    visual: str = Field(..., description="Natural language description of the visual composition")
